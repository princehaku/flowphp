...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo Flow::$cfg['base_url']; ?>/js/html5.js"></script>
    <![endif]-->
    <link href="<?php echo Flow::$cfg['base_url']; ?>/asserts/css/bootstrap.min.css" rel="stylesheet" />
    <link href="<?php echo Flow::$cfg['base_url']; ?>/asserts/css/bootstrap-responsive.min.css" rel="stylesheet" />
    <link href="<?php echo Flow::$cfg['base_url']; ?>/asserts/css/bootswatch.css" rel="stylesheet" />
</head>

<body class="preview" id="top" data-spy="scroll" data-target=".smartnav" data-offset="80">
<!-- Navbar
  ================================================== -->
        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse smartnav" id="main-menu">
                ...
                <!--<ul class="nav pull-right" id="main-menu-right">
                    <li><a rel="tooltip" target="_blank" href="http://builtwithbootstrap.com/"
                           title="Showcase of Bootstrap sites &amp; apps"
                           onclick="_gaq.push(['_trackEvent', 'click', 'outbound', 'builtwithbootstrap']);">Built With
                        Bootstrap <i class="icon-share-alt"></i></a></li>
                    <li><a rel="tooltip" target="_blank" href="https://wrapbootstrap.com/?ref=bsw"
                           title="Marketplace for premium Bootstrap templates"
                           onclick="_gaq.push(['_trackEvent', 'click', 'outbound', 'wrapbootstrap']);">WrapBootstrap <i
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" href="#"><span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-warning dropdown-toggle" data-toggle="dropdown" href="#"><span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
        ...
        <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <a class="btn btn-inverse dropdown-toggle" data-toggle="dropdown" href="#"><span
                            class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="#">Action</a></li>
                        <li><a href="#">Another action</a></li>
    ...
    <footer id="footer">
        ...
        <div class="links">
            ...
            <a rel="tooltip"
               ...
               title="Drag to your bookmarks bar">Bookmarklet</a>
        ...
        Based on <a href="http://twitter.github.com/bootstrap/">Bootstrap</a>. Hosted on <a
            href="http://pages.github.com/">GitHub</a>. Icons from <a
